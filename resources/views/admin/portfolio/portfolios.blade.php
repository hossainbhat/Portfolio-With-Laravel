@php
    ...
    $description= 'Portfolio List for Admin';
@endphp
                  ...
                  <tbody>
                    @if($portfolios->count()>0)
                      ...
                      <tr>
                          ...
                          <td>
                            <a href="{{route('admin.addEdit.portfolio',$portfolio['id'] )}}"><button class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></button></a> 
                            <a class="confirmDelete" record="portfolio" recoedid="{{$portfolio->id}}" href="javascript:void('0')"><button class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></button></a>
                          </td>
                      </tr>
                      @endforeach
                    @endif 

                  ...
                  <tbody>
                    ...
                    @foreach ($services as $key=>$service)
                      <tr>
                        ...
                        <td>
                          <a href="{{url('admin/add-edit-service/'.$service['id'] )}}"><button class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></button></a>
                          <a class="confirmDelete" record="service" recoedid="{{$service->id}}" href="javascript:void('0')"><button class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></button></a>
                        </td>
                      </tr>
                    @endforeach
                  @endif 
